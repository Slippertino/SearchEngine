...
struct database_integrity_check_request : context {
	...
	SE_CONTEXT(
		database_integrity_check_request, -1,
		database_name
	)
...
struct database_integrity_check_response : context {
	...
	SE_CONTEXT(
		database_integrity_check_response, -1,
		is_valid,
		status
	)
